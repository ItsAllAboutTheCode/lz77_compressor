...
Compile: 
This program was made to be multiplatform and therefore requires use of the WxWidgets-2.8.9 library
to compile the source code. If using gcc add the argument -fexceptions to allow exception handling

Copying: 
You may use and modify the sources of this program for whatever purpose as long as it does not involde
 malicious intent. I assume no responsibility for the results of any harm caused by the modification of these sources
